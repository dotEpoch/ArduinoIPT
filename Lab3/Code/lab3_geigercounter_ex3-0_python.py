...
text_file = open("P:\ArduinoIPT\Lab3\Data\lab3_data_CPI(130mm)_{0}.txt".format(date_format), "w")
data_points = []
...
plt.savefig("P:\ArduinoIPT\Lab3\Hist\lab3_hist_CPI(130mm)_{0}.png".format(date_format)) # plus or minus 5mm
plt.show()  
