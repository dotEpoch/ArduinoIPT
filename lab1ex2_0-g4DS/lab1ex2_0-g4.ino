...
/* int on = 10; // Specify the amount of time LED is on in miliseconds.
int off = 10; // Specify the amount of time LED is off in miliseconds. */

// Question 5: Setting both delays to zero.
int on = 10; // Specify the amount of time LED is on in miliseconds.
